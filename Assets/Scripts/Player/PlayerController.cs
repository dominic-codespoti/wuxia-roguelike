...
namespace Player
{
    ...
    class PlayerController : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            EventBus.Subscribe<Events.PlayerDamaged>(evt => ReceiveImpact(evt.Impact));
        }
        ...
        {
            var knockback = new Vector2(impact.x * _boxCollider.size.x, impact.y * _boxCollider.size.y);
